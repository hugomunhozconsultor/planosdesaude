  ...
  <div class="my-12 px-3 px-md-9">
    <div class="root pa-3">
      ...
      <v-btn
        ...
        :disabled="!form.nome || !form.email || !form.abordagem_preferida || !form.celular || !form.cep"
        :loading="loading"
        color="#024D90"
...
export default {
  ...
  methods: {
    async send () {
      ...
      if (!this.celularError && !this.cepError) {
        ...
        const config = {
          method: 'post',
          url: 'https://leads-161d.restdb.io/rest/leads-fam',
          headers: { 
  ...
  mounted() {
    this.$gtm.trackView('Cotação Familiar', '/cotacao/familiar')
  },
  head: {
    title: 'Cotação Familiar'
  }
}
</script>
